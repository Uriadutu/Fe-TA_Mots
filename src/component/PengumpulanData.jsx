  ...
  return (
    <div className="p-4 bg-white min-h-screen">
      <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center mb-6">
        <h1 className="text-md font-semibold text-gray-800">Unggah DataSet:</h1>
        <button
          className="px-20 py-2 mb-0 bg-white border border-gray-300 text-black text-sm rounded-md hover:bg-gray-100 transition duration-300"
        >
          Pilih File
        </button>
      </div>
        ...
        <table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
          ...
          <tbody className="bg-white text-gray-800">
            <tr className="hover:bg-gray-50 transition duration-200">
              ...
              <td className="px-4 py-2 border-b border-gray-200">bendera1.jpg</td>
...
export default PengumpulanData;
